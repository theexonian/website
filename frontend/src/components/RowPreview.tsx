interface ArticleRowPreview {
	tag: string;
	title: string;
	authors: { slug: string; fullname: string }[];
	description: string;
	thumbnail: { url: string };
	publishedAt: string;
}

export default function RowPreview({ article }: { article: ArticleRowPreview }) {
	const { tag, title, authors, description, publishedAt } = article;
