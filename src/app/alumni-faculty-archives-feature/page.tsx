			...
			<div className="prose font-serif">
				<p>
					<em>
						...
						who attended the Academy and was featured in a published
						issue of the newspaper. This Alumni-Faculty Archives
						initiative aims to increase publicity and accessibility
						to our archives resource, as well as sharing stories of
						community members from their days as an Exeter student.
				...
				<p></p>
				<h2>9/21/23 Feature: William Rawson</h2>
				<p>
					<strong>
				...
				<p></p>
				<h2>10/5/23 Feature: Diana Davis</h2>
				<p>
					<strong>
				...
				<p></p>
				<h2>10/26/23 Feature: Nicholas Unger</h2>
				<p>
					<strong>
				...
				<p>
					...
					acting. “Unger, too, was convincing in his role as John, a
					lonely man who comes to Connie and tries to make believe
					that she is actually his past love.”
				</p>
				<p>
					<strong>
				...
				<p>
					...
					cross-country, and now coaches the same team he competed on
					as a student. “Some of this unification can be attributed to
					the co-captains, Weiske and Unger, who took the races
					seriously, but helped to ease the tension with sudden
					renditions of the team song, ‘Danke Schon.’”
				</p>
				<p>
					<strong>
				...
				<p>
					...
					the top students in both Latin and Greek. “The largest
					prize, $lOOO, was awarded to Senior Nicholas Unger, who
					reached the level of 530 in Latin and 130 in Greek.”
				</p>
				<p>
					<strong>
						<em>
				...
				<p>
					...
					roleplay ancient Romans in a simplified version of the
					ancient Roman empire called the “Unger Games,” in the
					process of learning about Roman culture, history, mythology,
					and language. “Unger is a well-recognized figure on campus,
					known for his ceaseless passion for Latin and language and
					Roman culture, and love for running and support of the cross
					country team.”
				</p>
				<p>
				...
				<p></p>
				<h2>10/26/23 Feature: Brooks Moriarty</h2>
				<p>
					<strong>
				...
				<p>
					...
					the 500 yard freestyle! What a beast.
				</p>
				<p>
					<strong>
				...
				<p>
					...
					He’s an English teacher for a reason!
				</p>
				<p>
					“For someone from the midwest, this place opened up the
					world to me. Pre-internet, the only way other than reading a
					lot to really learn about the world and people outside of
					your community was to move and be in different places. So I
					feel very lucky to have had a chance to come to a place with
					kids from all over and to learn from what we shared and from
					differences. PEA opened up the world not just on campus but
					gave me a chance to do SYA in Spain. My to-be best friend
					also lived in Cilley and we went to Spain together. He was a
					lot braver than me and helped me take chances abroad to try
				...
				<p>
					<em>
						From the Archive Library: To filter searches, you should
						try multiples ways of spelling the individuals name.
						Always think about different ways ones name can be
						presented as well as nicknames and alias. That being
						said there will always be folks that appear in your
						search might not be the individual you are looking for.
						Remember you can also refine your search by time period
						(e.g., graduation year, appointment year, teaching
						years). There is also a really great “help” section on
						navigation bar on the Exonian Archive that helps with
						how to search.
					</em>
				</p>
			</div>
