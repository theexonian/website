	...
	return (
		<>
			<div className="px-3 w-full flex justify-center">
				<article className="max-w-none w-[50rem] lg:w-[38rem] prose prose-neutral dark:prose-invert pt-7 sm:pt-3 font-serif prose-figcaption:font-sans prose-p:indent-8">
